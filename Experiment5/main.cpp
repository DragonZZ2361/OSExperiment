...
int main(){
    ...
    std::cout << result_FCFS.average_time << " " << result_FCFS.weighted_average_time << std::endl;
    std::cout << result_SPN.average_time << " " << result_SPN.weighted_average_time << std::endl;
    std::cout << result_RR.average_time << " " << result_RR.weighted_average_time << std::endl;
